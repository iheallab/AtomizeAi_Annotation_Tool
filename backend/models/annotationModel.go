...
type Annotation struct {
	...
	AdjudicatorAddedTasks  []string           `json:"adjudicator_added_tasks" bson:"adjudicator_added_tasks"`
	AdjudicatorAddedReasoning string          `json:"adjudicator_added_reasoning" bson:"adjudicator_added_reasoning"`
